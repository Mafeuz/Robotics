...
ErrorFileX = fopen('MaxErrorX2.txt','wt');
ErrorFileY = fopen('MaxErrorY2.txt','wt');
ErrorFileZ = fopen('MaxErrorZ2.txt','wt');
IterationsFile = fopen('Iterations2.txt','wt');

ErrorFileRX = fopen('MaxErrorRX2.txt','wt');
ErrorFileRY = fopen('MaxErrorRY2.txt','wt');
ErrorFileRZ = fopen('MaxErrorRZ2.txt','wt');
...
while contador < LimiteTeste
    ...
    fprintf(ErrorFileX, ' %.15f ',errorX);
    fprintf(ErrorFileX,'\n');

    fprintf(ErrorFileY, ' %.15f ',errorY);
    fprintf(ErrorFileY,'\n');

    fprintf(ErrorFileZ, ' %.15f ',errorZ);
    fprintf(ErrorFileZ,'\n');

    fprintf(ErrorFileRX, ' %.15f ',errorRX);
    fprintf(ErrorFileRX,'\n');

    fprintf(ErrorFileRY, ' %.15f ',errorRY);
    fprintf(ErrorFileRY,'\n');

    fprintf(ErrorFileRZ, ' %.15f ',errorRZ);
    fprintf(ErrorFileRZ,'\n');

    fprintf(IterationsFile, ' %.15f ',index);
    fprintf(IterationsFile,'\n');
